...
import '../../../../models/vendas/estruturamercadologica/vendas_por_vendedor_grupo_model.dart';
import '../../../../repositories/vendas/estruturamercadologica/vendas_por_vendedor_grupo_repository.dart';
import '../../../../services/auth_service.dart';
import '../../../../services/cad_lojas_service.dart';
import '../../../../models/cadastros/cad_lojas.dart';
import 'vendas_por_vendedor_subgrupo_page.dart';

class VendasPorVendedorGrupoPage extends StatefulWidget {
  final int idEmpresa;
  ...
  const VendasPorVendedorGrupoPage({
    Key? key,
  ...
  @override
  State<VendasPorVendedorGrupoPage> createState() => _VendasPorVendedorGrupoPageState();
}

class _VendasPorVendedorGrupoPageState extends State<VendasPorVendedorGrupoPage> {
  ...
  late final VendasPorVendedorGrupoRepository _repository;
  late final CadLojasService _cadLojasService;

  List<Empresa> _empresas = [];
  List<Empresa> _empresasSelecionadas = [];
  DateTimeRange? _selectedDateRange;
  List<VendaPorVendedorGrupoModel> _resultados = [];
  bool _loading = true;
  ...
  void initState() {
    ...
    _repository = VendasPorVendedorGrupoRepository(_apiClient);
  ...
  Future<void> _carregarDados() async {
    ...
    final List<VendaPorVendedorGrupoModel> resultados = [];

    for (final empresa in _empresasSelecionadas) {
      final dados = await _repository.getVendasPorVendedorGrupo(
        idEmpresa: empresa.id,
        idVendedor: widget.idVendedor,
        idSecao: widget.idSecao ?? null,
                      ...
                      return GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (_) => VendasPorVendedorSubgrupoPage(
